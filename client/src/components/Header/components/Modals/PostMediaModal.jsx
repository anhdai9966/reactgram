  ...
  return (
    <div className="bg-white transition-all rounded-xl overflow-hidden text-[#262626]">
      <div className="relative p-2 flex-shrink-0 border-b">
        ...
        {!imageSrc && !isNext && <h6 className="text-center font-semibold">Tạo bài viết mới</h6>}
        {isNext && (
          <div className="flex items-center justify-between font-semibold">
          <button
      ...
      <div className={`divide-x font-light grid  grid-rows-[500px] ${isNext && "grid-cols-[500px_320px]"}`}>
        ...
        {isNext && (
          <div
          className="w-full h-full overflow-x-hidden overflow-y-scroll scrollbar-gutter">
